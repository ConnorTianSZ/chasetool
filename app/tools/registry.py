...
from app.tools.dashboard import query_aggregates, get_overview
...
def call_tool(name: str, args: dict, project_id: str = "default"):
    fn = TOOLS.get(name)
    if fn is None:
        return {"error": f"未知工具: {name}"}
    return fn(**args, project_id=project_id)
